...
{
    public class RequestQuestion : IEquatable<RequestQuestion>
    {
        public string Name;
        public ushort Type;
        public ushort Class;
        ...
        public bool Equals(RequestQuestion other) => other != null && Name == other.Name && Type == other.Type && Class == other.Class;
